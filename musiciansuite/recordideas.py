...
from PyQt5.QtWidgets import (
    ...
    QToolButton, QVBoxLayout, QWidget, QMenu, QAction)
...
class RecordIdeas(QWidget):
    ...
    def setupUi(self):
        ...
        self.recordedIdeasListWidget.setContextMenuPolicy(Qt.CustomContextMenu)
        self.recordedIdeasListWidget.customContextMenuRequested.connect(self.listWidgetRightClick)
    ...
    def listWidgetRightClick(self, position):
        widgetItem = self.recordedIdeasListWidget.itemAt(position)
            ...
            if widgetItem.text() != "New song...":
                ...
                if action == deleteAction:
                    ...
                    if msg == QMessageBox.Yes:
                        ...
                        queries("DELETE from recorded_ideas where title = ?", (title,))
                        self.populateList()
                        self.recordedIdeasListWidget.setCurrentRow(0)
    ...
    def checkIdea(self):
        ...
        self.titleEdit.setText(self.titleEdit.text().strip())
    ...
    def waveFormAvailable(self):
        ...
        try:
            ...
            QMessageBox.information(None, "Error", "Error, something has failed:\n\n%s" % e)
